...
model_filename = 'multimodal_100epochs_1000steps'
...
data = np.array([('ID_1', 'CT', image_filenames[0], label_filenames[0], (512,1024,1024), 'float32'),
              ('ID_2', 'HREM', image_filenames[1], label_filenames[1], (312,4096,4096), 'float32'),
              ('ID_3', 'RSOM', image_filenames[2], label_filenames[2], (376,256,256), 'float32')], dtype=dt)
...
val_data = np.array([('ID_1', 'CT', X_test_filenames[0], y_test_filenames[0], (170,1024,1024), 'float32'),
              ('ID_2', 'HREM', X_test_filenames[1], y_test_filenames[1], (104,4096,4096), 'float32'),
              ('ID_3', 'RSOM', X_test_filenames[2], y_test_filenames[2], (125,256,256), 'float32')], dtype=dt)
...
test_generator=DataGenerator(val_data_dir, **params)

roc_analysis(model=model_gpu, data_dir=val_data_dir, volume_dims=(64,64,64), batch_size=2, overlap=None, classes=(0,1))
